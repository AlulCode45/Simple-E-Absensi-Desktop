 ...
 * @author my komputer
 */
public class KelolaGuru extends javax.swing.JFrame {
    ...
    void getData() {
        String query = "SELECT wali_kelas.nama AS nama_guru, wali_kelas.username,  kelas.nama_kelas AS kelas "
                + "FROM wali_kelas "
                + "LEFT JOIN kelas ON wali_kelas.kelas_id = kelas.id";
        Connection con = null;
        ...
        try {
            ...
            while (result.next()) {
                String nama_guru = result.getString("nama_guru");
                String username = result.getString("username");
                String kelas = result.getString("kelas");

                Object[] data = {nama_guru, kelas, username};
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Kelola Guru");

        rSButtonMetro1.setText("Tambah Data");
        ...
        tableGuru.setColumnSelectionAllowed(true);
        jScrollPane1.setViewportView(tableGuru);
        tableGuru.getColumnModel().getSelectionModel().setSelectionMode(javax.swing.ListSelectionModel.SINGLE_SELECTION);
    ...
    private void rSButtonMetro1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rSButtonMetro1ActionPerformed
        ...
        TambahDataGuru tambahDataGuru = new TambahDataGuru();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(KelolaGuru.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new KelolaGuru().setVisible(true);
            }
        });
    }
