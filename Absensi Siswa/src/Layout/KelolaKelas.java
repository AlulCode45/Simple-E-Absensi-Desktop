 ...
 * @author my komputer
 */
public class KelolaKelas extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tableKelas.setColumnSelectionAllowed(true);
        tableKelas.getTableHeader().setReorderingAllowed(false);
        jScrollPane1.setViewportView(tableKelas);
        tableKelas.getColumnModel().getSelectionModel().setSelectionMode(javax.swing.ListSelectionModel.SINGLE_INTERVAL_SELECTION);
        if (tableKelas.getColumnModel().getColumnCount() > 0) {
            tableKelas.getColumnModel().getColumn(0).setResizable(false);
        }
    ...
    private void rSButtonMetro1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rSButtonMetro1ActionPerformed
        ...
        TambahDataKelas tambahKelas = new TambahDataKelas();
        tambahKelas.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(KelolaKelas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new KelolaKelas().setVisible(true);
            }
        });
    }
