 ...
 * @author my komputer
 */
public class KelolaSiswa extends javax.swing.JFrame {
    ...
    private void rSButtonMetro1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rSButtonMetro1ActionPerformed
        ...
        TambahDataSiswa tambahSiswa = new TambahDataSiswa();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(KelolaSiswa.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new KelolaSiswa().setVisible(true);
            }
        });
    }
