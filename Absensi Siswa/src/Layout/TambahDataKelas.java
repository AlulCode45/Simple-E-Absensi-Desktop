...
public class TambahDataKelas extends javax.swing.JFrame {
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(kelas, javax.swing.GroupLayout.PREFERRED_SIZE, 761, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void rSButtonMetro1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rSButtonMetro1ActionPerformed
        String nama_kelas = kelas.getText();
        Connection con = Utils.DbConnection.connectDb();
        try {
            String sql = "INSERT INTO kelas (nama_kelas) VALUES ('" + nama_kelas + "')";
            PreparedStatement insertKelas = con.prepareStatement(sql);
            int rowsInserted = insertKelas.executeUpdate();
            if (rowsInserted > 0) {
                JOptionPane.showMessageDialog(null, "Sukses Menambahkan Kelas", "Success", JOptionPane.INFORMATION_MESSAGE);
            } else {
                JOptionPane.showMessageDialog(null, "Gagal menqambahkan kelas", "Failure", JOptionPane.ERROR_MESSAGE);
            }
        } catch (Exception e) {
